...
SceneBasic_Uniform::SceneBasic_Uniform() : tPrev(0), angle(0.0f), rotSpeed(glm::pi<float>()/8.0f),
plane(50.0f,50.0f,1,1),teapot(14,mat4(1.0f)),torus(0.7f*1.5f,0.3*1.5f,50,50)  {
...
void SceneBasic_Uniform::pass1()
{
	...
	prog.setUniform("Light.Position", glm::vec4(1.0f, 0.0f, 0.0f, 1.0f));
